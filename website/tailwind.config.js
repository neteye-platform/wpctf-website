...
export default {
  ...
  theme: {
    ...
    fontSize: {
      ...
      '1.25xl': ['1.3rem', { lineHeight: '1.8rem' }],
      '1.5xl': ['1.325rem', { lineHeight: '1.85rem' }],
      '1.75xl': ['1.4rem', { lineHeight: '2rem' }],
      '2xl': ['1.5rem', { lineHeight: '2rem' }],
      '2.5xl': ['1.675rem', { lineHeight: '2rem' }],
      '2.75xl': ['1.775rem', { lineHeight: '2rem' }],
      '3xl': ['1.875rem', { lineHeight: '2.25rem' }],
      '4xl': ['2.25rem', { lineHeight: '2.5rem' }],
      '4.5xl': ['2.625rem', { lineHeight: '2.5rem' }],
      '5xl': ['3rem', { lineHeight: '1' }],
      '5.25xl': ['3.175rem', { lineHeight: '1' }],
      '5.5xl': ['3.375rem', { lineHeight: '1' }],
      '6xl': ['3.75rem', { lineHeight: '1' }],
      '6.25xl': ['3.85rem', { lineHeight: '1' }],
      '6.5xl': ['4.125rem', { lineHeight: '1' }],
      '7xl': ['4.5rem', { lineHeight: '1' }],
      '7.5xl': ['5rem', { lineHeight: '1' }],
      '7.75xl': ['5.5rem', { lineHeight: '1' }],
      '8xl': ['6rem', { lineHeight: '1' }],
      '9xl': ['8rem', { lineHeight: '1' }],
      '9.5xl': ['9rem', { lineHeight: '1' }],
