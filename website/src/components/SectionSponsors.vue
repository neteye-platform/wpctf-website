    ...
    <div class="grid grid-cols-12 px-5 xl:px-10 text-terminal-text text-shadow-glow-low">
      ...
      <div class="xl:col-span-4 col-span-12 flex text-shadow-glow-low">
        <p class="block text-1.25xl">
          ...
          <br />
          <br />
          <a href="https://volksbank.it" class="xl:hover:text-white"
          >>> https://volksbank.it
          </a>
        </p>
      </div>
      ...
      <div class="xl:col-span-4 col-span-12 flex text-shadow-glow-low">
        <p class="block text-1.25xl">
          ...
          <br />
          <br />
          <a href="https://www.innovatrieste.it/" class="xl:hover:text-white"
          >>> https://www.innovatrieste.it/
          </a>
        </p>
      </div>
      ...
      <div class="xl:col-span-4 col-span-12 flex text-shadow-glow-low">
        <p class="block text-1.25xl">
          ...
          <br />
          <br />
          <a href="https://gravitate.eu/" class="xl:hover:text-white"
          >>> https://gravitate.eu
          </a>
        </p>
      </div>
      ...
      <div class="xl:col-span-4 col-span-12 flex text-shadow-glow-low">
        <p class="block text-1.25xl">
          ...
          As software being vital part of DC charging solutions, we develop operating systems and backend ops-support software.<br>
          ...
          <br />
          <br />
          <a href="https://www.alpitronic.it/" class="xl:hover:text-white"
          >>> https://www.alpitronic.it/
          </a>
        </p>
      </div>
      ...
      <div class="xl:col-span-3 col-span-12 flex xl:ml-8" id="hgv">
        <div>
          <a
              class="text-5xl xl:text-5xl text-left font-W95FA heading mb-7 xl:mb-0xl:hover:text-whitexl:hover:opacity-80 transition-all"
      ...
      <div class="xl:col-span-4 col-span-12 flex text-shadow-glow-low">
        <p class="block text-1.25xl">
          ...
          <br />
          <br />
          <a href="https://www.hgv.it/" class="xl:hover:text-white"
          >>> https://www.hgv.it/
          </a>
        </p>
      </div>
      ...
      <div class="xl:col-span-4 col-span-12 flex text-shadow-glow-low">
        <p class="block text-1.25xl">
          ...
          <br />
          <br />
          <a href="https://www.wuerth.it/azienda/wurth-italia/" class="xl:hover:text-white"
          >>> https://www.wuerth.it/azienda/wurth-italia/
          </a>
        </p>
      </div>
      ...
      <div class="xl:col-span-4 col-span-12 flex text-shadow-glow-low">
        <p class="block text-1.25xl">
          ...
          <br />
          <br />
          <a href="https://www.longo.media/en/" class="xl:hover:text-white"
          >>> https://www.longo.media/en/
          </a>
        </p>
      </div>
