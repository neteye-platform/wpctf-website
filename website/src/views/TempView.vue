<template>
  <div id="loader" class="fixed top-0 left-0 w-full h-full z-[1000] bg-black flex justify-center flicker crt">
    <svg>
      <defs>
    ...
    <div class="container justify-center">
      <header data-content="Website is loading" class="font-alternate text-center items-center whitespace-nowrap !mx-auto">
      ...
      <div class="mx-auto w-full flex justify-center text-center text-2xl lg:text-3xl text-white pt-8 lg:pt-12">
        ETC: 1st of May 2024
      </div>
    </div>
  </div>
...
onMounted(()=> {
  gsap.to("#loader", {  autoAlpha: 0, duration: .3, delay: 2.2
  });
  setTimeout(() => {
...
#loader{
  ...
  header::before {
    ...
    animation:
        header_glitch .4s step-end infinite,
        header_clip-before .7s linear forwards infinite;
  }
  ...
  .loading-bar::before {
    ...
    transition-duration: var(--transition-time);
    max-width: 90%;
    animation: loading-bar_progress 1.8s linear forwards;
  }
