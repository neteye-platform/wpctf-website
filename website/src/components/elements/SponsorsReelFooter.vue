<template>
  <div class="block w-screen xl:w-auto overflow-scroll xl:overflow-hidden text-nowrap !mt-0 z-10 hide-scrollbar">
    <div id="reelFooter" class="w-auto text-nowrap space-x-16 md:space-x-20 lg:space-x-32 xl:space-x-44 relative xl:-left-[28%]">
