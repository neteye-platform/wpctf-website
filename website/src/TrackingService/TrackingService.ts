...
class TrackingServiceWrapper {
  ...
  public eventRegistrationUsernameInput(command: string): void {
    //@ts-ignore
    window._paq.push(["trackEvent", "registration", "username", command]);
  }

  public eventRegistrationPasswordInput(command: string): void {
    //@ts-ignore
    window._paq.push(["trackEvent", "registration", "password", command]);
  }

  public eventRegistrationSolved(): void {
    //@ts-ignore
    window._paq.push(["trackEvent", "registration", "solved"]);
  }
}
